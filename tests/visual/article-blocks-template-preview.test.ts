...
test('KIBER-94 article template includes full live-derived block library', () => {
  ...
  assert.match(component, /<EditorialHero data-block-id="hero"/);
  assert.match(readFileSync('src/components/blocks/EditorialHero.astro','utf8'), /<section id="hero" class="editorial-hero"/);
