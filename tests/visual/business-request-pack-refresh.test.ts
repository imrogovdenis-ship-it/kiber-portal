...
test('business request pack reflects closed media approval and only remaining owner inputs', () => {
  ...
  assert.match(doc, /реальные публичные контакты/i);
