...
test('KIBER-94 Astro templates expose stable block markers and do not render service-only sections', () => {
  const expectations = [
    { path: robotTemplatePath, pageType: 'robot_card', blocks: ['hero', 'aiSummary', 'gallery', 'description', 'capabilities', 'scenarios', 'robotInAction', 'goshaCta', 'pricing', 'includedService', 'structuredFacts', 'orderFlow', 'faq', 'finalQuestionsCta', 'articles', 'relatedCatalog'] },
