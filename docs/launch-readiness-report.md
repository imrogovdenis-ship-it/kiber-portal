...
2. Keep lazy-loaded below-fold media behaviour separate from real missing media assets; do not copy/download replacement assets until DOM/image checks confirm they are missing.
