...
## Update 2026-08-29 — media rights resolved

- Approved by: Александр Маркин
- Approved at: `2026-08-29T00:55:09Z`
- Scope: all 24 full robot media cards generated by the same validated schema/principle.
- Evidence: `data/review/media-rights-robot-cards.json`, `docs/review/media-rights/robot-cards/README.md`.
- Production deploy, DNS, secrets, analytics IDs/cookies, real public contacts and live lead routing remain separately blocked.
