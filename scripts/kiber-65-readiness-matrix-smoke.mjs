...
if (routes.filter(r => r.template === 'article-detail' && r.sitemap).length !== 12) failures.push('twelve approved article routes required: six humanoid and six robot-dogs articles');
