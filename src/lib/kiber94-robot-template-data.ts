import uvboxRemediation from '../../data/content/robot-card-pilot/arenda-uv-box.json';
import clipmakerRemediation from '../../data/content/robot-card-pilot/arenda-klipmeiker.json';
import glambotRemediation from '../../data/content/robot-card-pilot/arenda-glambot.json';
import a4Remediation from '../../data/content/robot-card-pilot/arenda-robota-hudozhnika-a4.json';
import sketchbotRemediation from '../../data/content/robot-card-pilot/arenda-sketchbot.json';
...
const batch1ReviewGalleryBySlug: Record<string, Array<{ src: string; alt: string; sourceStatus: 'page_content' }>> = {
  ...
  'arenda-robota-hudozhnika-a4': [
    ...
    { src: "/images/kiber-94-preview/batch3-robot-cards/arenda-robota-hudozhnika-a4__tild6434-3038-4462-a265-313833396538__09.webp", alt: "Робот-художник крупным планом на светлом фоне: виден только манипулятор, который держит карандаш.", sourceStatus: 'page_content' as const },
    { src: "/images/kiber-94-preview/batch3-robot-cards/arenda-robota-hudozhnika-a4__tild3034-3566-4665-b136-633866383265__03.webp", alt: "Робот-художник рисует портрет: лист закреплён на деревянном холсте, виден манипулятор сзади, стол, холст и стена на фоне. Аренда робота-художника для мероприятия и интерактивной зоны.", sourceStatus: 'page_content' as const },
    { src: "/images/kiber-94-preview/batch3-robot-cards/arenda-robota-hudozhnika-a4__tild3364-3836-4633-b538-633865636364__01.webp", alt: "Изображение роботизированной руки робота-художника на сером фоне.", sourceStatus: 'page_content' as const },
    { src: "/images/kiber-94-preview/batch3-robot-cards/arenda-robota-hudozhnika-a4__tild3438-3431-4038-b939-396465653237__02.webp", alt: "Манипулятор робота-художника крупным планом рисует изображение на мероприятии; виден сам процесс рисования. Аренда робота-художника для мероприятия и интерактивной зоны.", sourceStatus: 'page_content' as const },
    { src: "/images/kiber-94-preview/batch3-robot-cards/arenda-robota-hudozhnika-a4__tild3138-6562-4865-b933-313264613765__06.webp", alt: "Крупный план манипулятора робота-художника на мероприятии, на фоне проходят люди.", sourceStatus: 'page_content' as const },
    { src: "/images/kiber-94-preview/batch3-robot-cards/arenda-robota-hudozhnika-a4__tild6339-3766-4133-a566-356232306263__08.webp", alt: "Роботизированная рука робота-художника установлена на столе; рядом лежит холст и масляные краски, манипулятор кисточкой рисует изображение красками. Аренда робота-художника для мероприятия и интерактивной зоны.", sourceStatus: 'page_content' as const },
    { src: "/images/kiber-94-preview/batch3-robot-cards/arenda-robota-hudozhnika-a4__tild3135-3665-4635-a234-313737613137__07.webp", alt: "Роботизированная рука робота-художника в офисе компании в процессе тестирования; на заднем фоне стол, монитор и компьютер.", sourceStatus: 'page_content' as const },
    { src: "/images/kiber-94-preview/batch3-robot-cards/arenda-robota-hudozhnika-a4__tild3033-3262-4138-b338-326636666339__04.webp", alt: "Процесс создания изображения: на металлическом столе на конференции установлен робот-художник, перед ним деревянная конструкция с закреплённым листом бумаги, идёт рисование. Аренда робота-художника для мероприятия и интерактивной зоны.", sourceStatus: 'page_content' as const },
  ],
...
'arenda-robota-hudozhnika-a4': { title: "Аренда робота-художника для мероприятий", description: "Робот-художник рисует портреты гостей на бумаге: творческая зона для свадеб, премий, корпоративов и стендов. Расчёт аренды под событие.", h1: "Аренда робота-художника", primaryKeyword: "аренда робота-художника", secondaryKeywords: ["прокат робота-художника", "заказать робота-художника на мероприятие", "робот-художник для выставки", "робот-художник для корпоративного мероприятия", "робот-художник на мероприятие", "робот для творческой зоны"] },
...
const ownerSeoIntentBySlug: Record<string, OwnerSeoIntent> = {
  ...
  'arenda-robota-hudozhnika-a4': { pageType: 'robot_card', pageIntent: 'commercial_robot_rental', primaryKeyword: "аренда робота-художника", secondaryKeywords: ["прокат робота-художника", "заказать робота-художника на мероприятие", "робот-художник для выставки", "робот-художник для корпоративного мероприятия", "робот-художник на мероприятие", "робот для творческой зоны"], modelNameVariants: ["робот-художник", "робот-художник"], entitySynonyms: ["робот для мероприятия", "интерактивная зона", "drawing_robot"], aiAgentHints: ['Страница отвечает на запрос аренды этого робота и помогает понять, подойдёт ли он под событие.', 'Цена, сценарий, доступность и требования площадки подтверждаются менеджером КИБЕР ПОРТАЛ.'], entity: { type: 'Robot', name: "робот-художник", model: "робот-художник", category: "drawing_robot", canonicalPath: '/robots/arenda-robota-hudozhnika-a4/' }, isCrawlerOnlyText: false },
...
const ownerFaqBySlug: Record<string, OwnerFaqOverride> = {
  ...
  'arenda-robota-hudozhnika-a4': [
    { question: "Для каких мероприятий подходит робот-художник?", answer: "Робот-художник подходит для свадеб, премий, корпоративов, выставок, презентаций и камерных VIP-событий, где нужен персональный портрет на бумаге и спокойная творческая зона." },
    { question: "Чем робот-художник отличается от Sketchbot?", answer: "A4 делает акцент на бумажном портрете формата A4 и более детальном сувенире. Его выбирают, когда важен не только интерактив, но и вещь, которую гость унесёт с собой." },
    ...
    { question: "Подходит ли робот-художник для плотного потока гостей?", answer: "Подходит, если правильно ограничить время портрета и организовать очередь. Если гостей много, лучше заранее рассчитать смену, число работ и возможные паузы." },
    { question: "Сколько стоит аренда робота-художника?", answer: "Стоимость зависит от города, даты, длительности, детализации портретов, расходников, брендинга, логистики и оператора. Менеджер уточнит задачу и подготовит расчёт." }
  ],
...
const ownerAiSummaryBySlug: Record<string, string> = {
  ...
  'arenda-robota-hudozhnika-a4': "Робот-художник — творческая зона с бумажными портретами формата A4. Его выбирают для свадеб, премий, корпоративов и VIP-событий, где важен не только процесс рисования роботом, но и сувенир, который гость забирает с собой.",
...
const ownerRobotCardCopyBySlug: Record<string, OwnerRobotCardCopy> = {
  ...
  'arenda-robota-hudozhnika-a4': {
    capabilitiesLead: "Робот-художник подходит для событий, где нужен более крупный и заметный бумажный портрет. Здесь важно не обещать мгновенную выдачу: качество, детализация и очередь зависят от выбранного режима рисования.",
    capabilities: [
...
const ownerGoshaQuoteBySlug: Record<string, string> = {
  ...
  'arenda-robota-hudozhnika-a4': "— Робот-художник не обещает портрет “за три секунды и с душой академика”. Зато он честно превращает ожидание в процесс: гости смотрят, как робот выводит линии, и забирают с собой настоящий лист, а не только сторис.\n\nНапишите менеджеру: подберём режим детализации, расходники, брендинг листа и расчёт очереди под ваше событие.",
